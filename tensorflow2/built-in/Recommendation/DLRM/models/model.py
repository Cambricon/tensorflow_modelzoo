...
from models.embedding import Embedding, SplitEmbedding
from models import interaction
import tensorflow.keras.initializers as initializers
import math
import horovod.tensorflow as hvd
from models.distributed_utils import BroadcastingInitializer
import numpy as np
import time
from models.utils import dist_print
...
class Dlrm(tf.keras.Model):
    def __init__(self, FLAGS, dataset_metadata, multi_mlu_metadata):
        super(Dlrm, self).__init__()
        local_table_ids = multi_mlu_metadata.rank_to_categorical_ids[hvd.rank()]
        self.table_sizes = [dataset_metadata.categorical_cardinalities[i] for i in local_table_ids]
        self.rank_to_feature_count = multi_mlu_metadata.rank_to_feature_count
    ...
    def _call_alltoall(self, embedding_outputs, bottom_mlp_out=None):
        ...
        alltoall_output = tf.split(alltoall_output[0],
