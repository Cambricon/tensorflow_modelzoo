...
# ==============================================================================
"""Runs a InceptionV2 model on the ImageNet dataset."""
...
from models.vision import test_utils
from models.vision.inceptionv2 import common
from models.vision.inceptionv2 import imagenet_preprocessing
from models.vision.inceptionv2 import inceptionv2_model


def run(flags_obj):
  """Run InceptionV2 ImageNet training and eval loop using native Keras APIs.
  ...
  tf.python.keras.backend.set_image_data_format(data_format)
  ...
  # Current inceptionv2_model.inceptionv2 input format is always channel-last.
  ...
  with strategy_scope:
    if flags_obj.optimizer == 'resnet50_default':
      ...
      optimizer = tf.python.keras.optimizers.SGD(
          learning_rate=tf.python.keras.optimizers.schedules.ExponentialDecay(
              initial_learning_rate,
              decay_steps=steps_per_epoch * flags_obj.num_epochs_per_decay,
              decay_rate=flags_obj.lr_decay_factor,
              staircase=True),
          momentum=0.9)
    elif flags_obj.optimizer == 'inceptionv2_default':
        initial_learning_rate = \
            flags_obj.initial_learning_rate_per_sample * flags_obj.batch_size
    ...
    elif flags_obj.model == 'inceptionv2':
        model = inceptionv2_model.inceptionv2(
            classes=imagenet_preprocessing.NUM_CLASSES
        )
