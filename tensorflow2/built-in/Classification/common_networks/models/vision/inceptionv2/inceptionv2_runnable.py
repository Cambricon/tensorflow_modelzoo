...
# ==============================================================================
"""Runs a InceptionV2 model on the ImageNet dataset using custom training loops."""
...
from models.staging.training import grad_utils
from models.staging.training import standard_runnable
from models.staging.training import utils
...
class InceptionV2Runnable(standard_runnable.StandardTrainable,
                     standard_runnable.StandardEvaluable):
  """Implements the training and evaluation APIs for InceptionV2 model."""
  ...
  def __init__(self, flags_obj, time_callback, epoch_steps):
    ...
    self.model = inceptionv2_model.inceptionv2(
    ...
    def step_fn(inputs):
      ...
      with tf.GradientTape() as tape:
        ...
        if self.flags_obj.single_l2_loss_op:
          l2_loss = inceptionv2_model.L2_WEIGHT_DECAY * 2 * tf.add_n([
              tf.nn.l2_loss(v)
