...
# usage: models >: ./model/utils/testing/scripts/presubmit.sh
# usage: models >: ./model/utils/testing/scripts/presubmit.sh lint py2_test py3_test
set +x
...
py_test() {
  ...
  for test_file in `find model/ -name '*test.py' -print`
  do
