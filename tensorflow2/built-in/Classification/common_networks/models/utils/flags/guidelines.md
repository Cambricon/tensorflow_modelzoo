...
1. **All common flags must be incorporated in the models.**
   ...
   and channeled through `model.utils.flags.core`. For instance to define common supervised
...
2. **Validate flag values.**
   ...
   Validators in the model model repo should not access the file system, such as verifying
