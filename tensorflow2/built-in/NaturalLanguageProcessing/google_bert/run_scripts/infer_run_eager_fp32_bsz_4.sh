...
TF_MODELS_DIR=/data/tensorflow/training/models/tf2mm/saved_model/BertBase/
export PYTHONPATH=$cur_path:${TF_MODELS_DIR}:${PYTHONPATH}
data_dir=/data/tensorflow/training/datasets/tf2_bert/
...
native_savedmodel_dir=/data/tensorflow/training/models/tf2mm/saved_model/BertBase/
