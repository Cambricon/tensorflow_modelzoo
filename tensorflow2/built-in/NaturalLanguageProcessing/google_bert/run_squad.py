...
#import modeling_mlu as modeling
import optimization
import tokenization
import six
  ...
  def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
    ...
    if mode == tf.estimator.ModeKeys.TRAIN:
      ...
      train_op = optimization.create_optimizer(
          total_loss, learning_rate, num_train_steps, num_warmup_steps, use_tpu, FLAGS.use_horovod, FLAGS.use_amp)
  ...
  if FLAGS.do_train:
    ...
    if FLAGS.use_horovod:
      train_writer = FeatureWriter(
          filename=tmp_filenames[hvd.rank()],
          is_training=True)
