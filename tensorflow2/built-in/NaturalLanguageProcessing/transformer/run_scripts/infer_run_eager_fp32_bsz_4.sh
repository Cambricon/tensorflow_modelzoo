...
data_dir=/data/tensorflow/training/datasets/transformer_data
...
native_savedmodel_dir=/data/tensorflow/training/models/tf2mm/mm_compare_saved_model/transformer/
