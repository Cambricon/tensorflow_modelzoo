...
def parse_cmdline():
    ...
    p.add_argument(
        ...
        type=str2bool,
        required=False,
        help="Enable Automatic Mixed Precision to speedup FP32 computation using tensor cores on MLU"
    )
    ...
    p.add_argument(
        ...
        type=str2bool,
        required=False,
        help="Whether to use use_performance test tools."
    )
    ...
    p.add_argument(
        ...
        type=str2bool,
        required=False,
        help="Whether to use profiler tools."
    )
    ...
    _add_bool_argument(
        parser=p, name="use_auto_loss_scaling", default=True, required=False, help="Use AutoLossScaling with TF-AMP"
    )
    ...
    p.add_argument(
        ...
        type=str2bool,
        required=False,
        help="Choose whether to use hvd"
    )
