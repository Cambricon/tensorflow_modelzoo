...
def tacotron_synthesize(args, hparams, checkpoint, sentences=None):
	...
	if hparams.tacotron_synthesis_batch_size < hparams.tacotron_num_devices:
		raise ValueError('Defined synthesis batch size {} is smaller than minimum required {} (num_devices)! Please verify your synthesis batch size choice.'.format(
			hparams.tacotron_synthesis_batch_size, hparams.tacotron_num_devices))

	if hparams.tacotron_synthesis_batch_size % hparams.tacotron_num_devices != 0:
		raise ValueError('Defined synthesis batch size {} is not a multiple of {} (num_devices)! Please verify your synthesis batch size choice!'.format(
			hparams.tacotron_synthesis_batch_size, hparams.tacotron_num_devices))
