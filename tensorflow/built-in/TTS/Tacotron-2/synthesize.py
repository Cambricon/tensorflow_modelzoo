...
def prepare_run(args):
	hp = "tacotron_num_devices={}, tacotron_batch_size={}, tacotron_synthesis_batch_size={}, device_type={}".format(args.tacotron_num_devices, args.tacotron_batch_size, args.tacotron_synthesis_batch_size, args.device_type)
...
def main():
	...
	parser.add_argument('--taco_checkpoint', default='logs-Tacotron-2/taco_pretrained/', help='Path to taco model checkpoint')
	parser.add_argument('--hparams', default='',
		help='Hyperparameter overrides as a comma-separated list of name=value pairs')
	parser.add_argument('--tacotron_num_devices', default=1, help='Determines the number of devices in use for Tacotron training.')
	parser.add_argument('--tacotron_batch_size', default=32, help='number of training samples on each training steps')
	parser.add_argument('--tacotron_synthesis_batch_size', default=1, help='number of batchsize in eval')
	parser.add_argument('--device_type', default='mlu', help='which device to use, must be mlu or gpu.')
