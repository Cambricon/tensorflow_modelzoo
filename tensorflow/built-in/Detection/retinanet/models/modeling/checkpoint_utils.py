...
def make_restore_checkpoint_fn(keras_model, checkpoint_path, prefix='', skip_regex=None):
  ...
  """
  #def _restore_checkpoint_fn(scaffold, sess):
  ...
  saver = tf.train.Saver(vars_to_load, reshape=False)
  saver.build()
