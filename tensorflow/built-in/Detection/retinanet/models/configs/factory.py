...
from models.configs import maskrcnn_config
from models.configs import retinanet_config
from models.configs import yolo_config
...
def config_generator(model):
  ...
  if model == 'retinanet':
    ...
    default_config = yolo_config.YOLO_CFG
    restrictions = yolo_config.YOLO_RESTRICTIONS
