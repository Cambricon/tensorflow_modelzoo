  ...
  for line in lines_list:
    try:
      if "difficult" in line:
          ...
          class_name1, class_name2, left, top, right, bottom = line.split()
...
for class_index, class_name in enumerate(gt_classes):
  ...
  for txt_file in predicted_files_list:
    ...
    for line in lines:
      try:
          if len(line.split()) > 6:
              tmp_class_name1, tmp_class_name2, confidence, left, top, right, bottom = line.split()
              tmp_class_name = tmp_class_name1 + "_" + tmp_class_name2
          else:
