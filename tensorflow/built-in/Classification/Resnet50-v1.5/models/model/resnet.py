...
class ResnetModel(object):
    ...
    def __init__(
        ...
        if (self.use_hvd_ and hvd.rank() == 0) or not self.use_hvd_:
            print("Model HParams:")
    ...
    def __call__(self, features, labels, mode, params):
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            mandatory_params = ["batch_size", "lr_init", "num_mlus", "steps_per_epoch",
        ...
        if mode == tf.estimator.ModeKeys.TRAIN and not self.model_hparams.use_dali:
            ...
            with tf.device('/mlu:0'):
                ...
                mlu_prefetch_op, (features, labels) = self._stage([features, labels])
            ...
            with tf.device("/mlu:0"):
                ...
                if mode == tf.estimator.ModeKeys.TRAIN:
                    ...
                    if self.model_hparams.use_dali:
                        ...
                        train_ops = tf.group(backprop_op, cpu_prefetch_op, mlu_prefetch_op, update_ops, name='train_ops')
