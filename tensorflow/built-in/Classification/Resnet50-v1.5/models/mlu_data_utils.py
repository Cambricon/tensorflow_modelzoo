...
def get_tfrecords_input_fn(filenames, batch_size, height, width, training, distort_color, num_threads, deterministic, use_hvd):
...
def get_dali_input_fn(
    filenames, idx_filenames, batch_size, height, width, training, distort_color, num_threads, deterministic, device
):
    ...
    if device.lower() == "mlu":
        import mlu_dali_utils as dali_utils
        global dali_utils
    else:
