...
def learning_rate_scheduler(lr_init, lr_warmup_epochs, global_step, batch_size,
                            num_batches_per_epoch, num_decay_steps, num_devices, use_cosine_lr):
    ...
    def get_scaled_base_learning_rate():
        ...
        lr * num_devices. Dividing the base lr by num_devices negates the increase.
        Args:
