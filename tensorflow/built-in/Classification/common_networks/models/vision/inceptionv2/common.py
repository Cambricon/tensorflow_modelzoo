...
def define_keras_flags(
  ...
  if model:
    flags.DEFINE_string('model', 'inceptionv2',
                        'Name of model preset. (mobilenet, resnet50_v1.5, inceptionv2)')
  if optimizer:
    flags.DEFINE_string('optimizer', 'inceptionv2_default',
                        'Name of optimizer preset. '
                        '(mobilenet_default, resnet50_default, inceptionv2_default)')
