...
from models.staging.training import controller
...
from models.vision.inceptionv2 import inceptionv2_runnable
...
def run(flags_obj):
  """Run InceptionV2 ImageNet training and eval loop using custom training loops.
  ...
  with distribution_utils.get_strategy_scope(strategy):
    runnable = inceptionv2_runnable.InceptionV2Runnable(flags_obj, time_callback,
                                              per_epoch_steps)
  ...
  inceptionv2_controller = controller.Controller(
      strategy,
      runnable.train,
      runnable.evaluate,
  ...
  inceptionv2_controller.train(evaluate=not flags_obj.skip_eval)
