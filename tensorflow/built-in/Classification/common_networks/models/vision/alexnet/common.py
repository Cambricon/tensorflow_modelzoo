...
def define_keras_flags(
  ...
  if model:
    flags.DEFINE_string('model', 'alexnet',
                        'Name of model preset. (alexnet)')
  if optimizer:
    flags.DEFINE_string('optimizer', 'alexnet_default',
                        'Name of optimizer preset. '
                        '(mobilenet_default, resnet50_default, alexnet_default)')
