...
from models.vision.alexnet import alexnet_runnable
...
def run(flags_obj):
  """Run AlexNet ImageNet training and eval loop using custom training loops.
  ...
  with distribution_utils.get_strategy_scope(strategy):
    runnable = alexnet_runnable.AlexNetRunnable(flags_obj, time_callback,
                                              per_epoch_steps)
  ...
  alexnet_controller = controller.Controller(
      strategy,
      runnable.train,
      runnable.evaluate,
  ...
  alexnet_controller.train(evaluate=not flags_obj.skip_eval)
