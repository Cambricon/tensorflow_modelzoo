...
def run_regression(train_embeds, train_labels, test_embeds, test_labels):
    ...
    log = MultiOutputClassifier(SGDClassifier(loss="log", random_state=1), n_jobs=10)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_dir", type=str, help="Path to directory containing the dataset.")
    parser.add_argument("--embed_dir", type=str, help="Path to directory containing the learned node embeddings. Set to 'feat' for raw features.")
    parser.add_argument("--setting", type=str, help="Either val or test.")
