...
from nlp.transformer import misc
from nlp.utils.misc import model_helpers
...
def train_input_fn(params, ctx=None):
  ...
  return _read_and_batch_from_files(
      ...
      params["num_parallel_calls"], shuffle=shuffle,
      repeat=params["repeat_dataset"], static_batch=params["static_batch"],
      num_replicas=num_mlus if num_mlus else num_gpus, ctx=ctx)
